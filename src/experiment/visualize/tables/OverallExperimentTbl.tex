...
\hline
\textit{\textbf{PROJECT}}& \multicolumn{1}{l}{\textit{\textbf{BRANCH}}}& \multicolumn{1}{l}{\textit{\textbf{FIX_NLCF_DURATION_MS}}}& \multicolumn{1}{l}{\textit{\textbf{FIX_BORROW_DURATION_MS}}}& \multicolumn{1}{l}{\textit{\textbf{FIX_LIFETIME_CARGO_MS}}}& \multicolumn{1}{l}{\textit{\textbf{CARGO_CYCLES}}}& \multicolumn{1}{l}{\textit{\textbf{TOTAL_DURATION_MS}}}& \multicolumn{1}{l}{\textit{\textbf{COMMIT_URL}}}& \multicolumn{1}{l}{\textit{\textbf{SUCCESS}}}& \multicolumn{1}{l}{\textit{\textbf{FAILED_AT}}}& \multicolumn{1}{l}{\textit{\textbf{FEATURES}}}\\ \hline
petgraph & \textit{Arbitrary extraction 1} & \textit{54} & \textit{56} & \textit{275} & \textit{0} & \textit{385} & \textit{https://github.com/sewenthy/petgraph/commit/d19f4b889ce284c0f7112a1ca353e0f70a1732e6
} & \textit{True} & \textit{nan} & \textit{[]} \\
petgraph & \textit{Arbitrary extraction 2} & \textit{67} & \textit{113} & \textit{834} & \textit{0} & \textit{1015} & \textit{https://github.com/sewenthy/petgraph/commit/c8195698758d90f8436bda1ed1148b39b05fd850
} & \textit{True} & \textit{nan} & \textit{[]} \\
petgraph & \textit{Arbitrary extraction 3} & \textit{97} & \textit{106} & \textit{1372} & \textit{1} & \textit{1576} & \textit{https://github.com/sewenthy/petgraph/commit/c6ba1d11d84664fe0932f822becd17cc9722d5da
} & \textit{True} & \textit{nan} & \textit{["non_elidible_lifetimes"]} \\
petgraph & \textit{Arbitrary extraction 4} & \textit{78} & \textit{81} & \textit{1591} & \textit{0} & \textit{1751} & \textit{https://github.com/sewenthy/petgraph/commit/c6751666bb725e3f2e4affb679f7c4796f8e490f
} & \textit{True} & \textit{nan} & \textit{["immutable_borrow"]} \\
petgraph & \textit{Arbitrary extraction 5} & \textit{74} & \textit{55} & \textit{776} & \textit{0} & \textit{907} & \textit{https://github.com/sewenthy/petgraph/commit/66dd8edfed39d8a2eb8148233b80a76d9b3b4ec4
} & \textit{True} & \textit{nan} & \textit{["immutable_borrow","mutable_borrow"]} \\
petgraph & \textit{Arbitrary extraction 6} & \textit{94} & \textit{75} & \textit{863} & \textit{0} & \textit{1033} & \textit{https://github.com/sewenthy/petgraph/commit/014cfac307ca18f5a8d863b9f4e23148a5a6a6ef
} & \textit{True} & \textit{nan} & \textit{["immutable_borrow"]} \\
